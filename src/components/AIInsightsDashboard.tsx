  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        {showTrend && (
          <span className="text-xs font-bold text-[#21DBA4] bg-[#21DBA4]/10 px-2 py-0.5 rounded-full">{trend}</span>
        )}
      </div>

      {/* Main value - large and prominent */}
      <div className="flex items-baseline gap-2">
        <span className={cn("text-4xl font-bold tracking-tight tabular-nums", theme.text)}>{value}</span>
