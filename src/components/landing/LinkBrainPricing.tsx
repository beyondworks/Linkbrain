            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl pb-20 mx-auto">
               {plans.map((plan, idx) => (
                  <motion.div
                     ...
                     viewport={{ once: true }}
                     className={`relative rounded-3xl p-6 border flex flex-col ${plan.highlight
                  ...
                  >
                     ...
                     <button
                        onClick={() => {
                           if (plan.highlight) {
                              // Pro plan - redirect to Lemon Squeezy Checkout
                              ...
                              // Free trial - redirect to login/signup
                              window.location.href = '#app';
                           }
                        }}
                        className={`w-full py-2.5 rounded-xl font-bold text-xs mb-6 transition-all ${plan.highlight
