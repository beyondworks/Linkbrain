    ...
    return createPortal(
        ...
        >
            ...
            >
                {/* Header Toolbar */}
                <div
                    className={`border-b flex items-center justify-between px-6 shrink-0 transition-all ${theme === 'dark' ? 'border-slate-800 bg-slate-900' : 'border-slate-100 bg-white'}`}
                    style={{
                        height: isMobile ? 'calc(4rem + env(safe-area-inset-top))' : '72px',
