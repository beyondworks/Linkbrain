        ...
        <Card className="w-[380px]">
            <CardHeader className="text-center">
                <div className="flex justify-center mb-4">
                    <div className="w-12 h-12 rounded-xl bg-[#21DBA4] flex items-center justify-center">
                        <svg
                ...
                <CardTitle className="text-2xl font-bold">Linkbrain</CardTitle>
            ...
            <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                    <div className="flex justify-between items-center">
                        ...
                        <a
                            href="#"
                            className="text-xs text-[#21DBA4] hover:underline"
                        >
                            비밀번호 찾기
                        </a>
                    </div>
            ...
            <CardFooter className="flex-col gap-4">
                ...
                <p className="text-sm text-center text-muted-foreground">
                    계정이 없으신가요?{' '}
                    <a href="#" className="text-[#21DBA4] hover:underline">
                        회원가입
                    </a>
                </p>
            </CardFooter>
